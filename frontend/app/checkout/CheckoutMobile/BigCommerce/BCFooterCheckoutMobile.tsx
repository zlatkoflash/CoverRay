...
export default function BCFooterCheckoutMobile() {
  ...
  let itemsAll = [];
  if (cartBC) {
    itemsAll = [...cartBC.line_items.physical_items, ...cartBC.line_items.digital_items];
  }
    ...
    <div className="mobile-footer">
      <div className="footer-info">
        Step 3 of 3 • <span className="highlight" id="itemCount">
          {itemsAll.length} {itemsAll.length === 1 ? 'item' : 'items'}
        </span> in cart
      </div>
      ...
      <div className="footer-buttons">
        ...
        <button
          ...
          style={{
            flex: 1,
            pointerEvents: itemsAll.length === 0 ? "none" : "auto",
            opacity: itemsAll.length === 0 ? 0.5 : 1
