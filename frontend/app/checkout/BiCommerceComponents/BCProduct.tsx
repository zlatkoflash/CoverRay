      ...
      <>
        ...
        >
          ...
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginTop: '.5rem', opacity: addingToCart ? 0.5 : 1, pointerEvents: addingToCart ? 'none' : 'auto', cursor: addingToCart ? 'default' : 'pointer' }}>
            <button type="button" className="modal-btn primary" onClick={() => {
              addToCart();
            }}>
    ...
    <>
      ...
      >
        ...
        <div>
          ...
          <button type="button" className="modal-btn primary" style={{ opacity: addingToCart ? 0.5 : 1, pointerEvents: addingToCart ? 'none' : 'auto', cursor: addingToCart ? 'default' : 'pointer' }} onClick={() => {
